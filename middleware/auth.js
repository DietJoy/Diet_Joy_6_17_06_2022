...
module.exports = (req, res, next) => { 
  try {
    ...
    const decodedToken = jwt.verify(token, 'EUxExYQzt4fGBkQzwC'); // décodage du token avec la fonction vérify et la clé secrète
    ...
    if (req.body.userId && req.body.userId !== userId) { // on vérifie que l'user id est le bon
